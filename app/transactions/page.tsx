    ...
    <ErrorBoundary>
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <Link
            href="/transactions"
            className="flex items-center gap-1.5 h-9 px-3 rounded-[10px] border border-[rgba(0,0,0,0.06)] bg-white/70 text-[13px] text-[#4B4963] font-medium hover:border-[rgba(0,0,0,0.14)] hover:text-[#0F0E17] transition-all duration-150 focus-visible:ring-2 focus-visible:ring-[#7C3AED] focus-visible:ring-offset-2"
